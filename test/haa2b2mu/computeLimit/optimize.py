...
jsonPath='$CMSSW_BASE/src/UserCode/bsmhiggs_fwk/test/haa4b/samples_full2016_GGH.json' 
...
for signalSuffix in signalSuffixVec : 
   ...
   #                     Gcut[c-1].SetPoint(mi, float(vals[0]), float(vals[c+1]));
           ...
           SCRIPT.writelines("text2workspace.py card_combined.dat -o workspace.root -P UserCode.bsmhiggs_fwk.HiggsWidth:higgswidth --PO verbose --PO \'is2l2nu\' \n")
           #compute pvalue
