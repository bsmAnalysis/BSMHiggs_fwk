...
runProcess = cms.PSet(
    dtag  = cms.string("MC13TeV_Wh_amass50"),
    input = cms.untracked.vstring("/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_1.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_2.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_3.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_4.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_5.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_6.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_7.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_8.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_9.root",
                                  "/afs/cern.ch/user/s/sghiasis/public/ForGeorgia/MINIAOD_Jul_20/Wh_production_a_mass_50/MINIAOD_10.root"
),
    outfile = cms.string("/afs/cern.ch/work/g/georgia/BSMAnalysis/CMSSW_8_0_26_patch1/src/UserCode/bsmhiggs_fwk/test/haa4b/ntuples/MC13TeV_Wh_amass50_0.root"),
    isMC = cms.bool(True),
