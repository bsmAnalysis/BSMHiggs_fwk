...
runProcess = cms.PSet(
    ...
    mvaBDT_Trib = cms.string("${CMSSW_BASE}/src/UserCode/bsmhiggs_fwk/data/weights/Haa4bSBClassificationTribMVA_BDT.weights.xml"),
    mvaBDT_Quab = cms.string("${CMSSW_BASE}/src/UserCode/bsmhiggs_fwk/data/weights/Haa4bSBClassificationQuabMVA_BDT.weights.xml"),
