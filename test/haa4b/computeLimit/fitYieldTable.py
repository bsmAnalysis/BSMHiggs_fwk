...
parser.add_argument( "limit_dir", type=str, help="Input directory for the mass point.  Example = cards_SB13TeV_SM_Wh_2017_noSoftb/")
...
for chan in chans:
   ...
   tex_file_name = "{}/yield-table-in-bdt-bins-{}-{}-{}.tex".format(limit_dir, year, wz, chan)
