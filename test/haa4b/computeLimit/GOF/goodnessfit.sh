...
cd ../cards_SB13TeV_SM_Wh_2016_noSoftb/0060/ 

# run distribution for ee channel
combine -M GoodnessOfFit -d workspace.root --algo=saturated -n _result_sb
...
combine -M GoodnessOfFit -d workspace.root --algo=saturated -n result_toy_sb --toysFrequentist -t 200
