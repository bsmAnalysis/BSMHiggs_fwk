...
runProcess = cms.PSet(
    #input = cms.string("/afs/cern.ch/work/g/georgia/BSMAnalysis/CMSSW_8_0_26_patch1/src/UserCode/bsmhiggs_fwk/test/haa4b/ntuples/MC13TeV_Wh_amass50_0.root"),
    input = cms.string("/uscms_data/d3/hwei/Haa4b/signalNtuple/MC13TeV_Wh_amass50_0.root"),
    ...
    outdir = cms.string("/uscms_data/d3/hwei/Haa4b/STDTest/results_Ntpl_2017_12_20"),
    tag = cms.string("MC13TeV_Wh_amass50"),
