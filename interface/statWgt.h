...
const std::map<std::string, std::pair <int, float> > mStat = 
{
    ...
    //WJets
    { "MC13TeV_WJets_2016"     , std::make_pair(86731806, 61526.7) }, //280929804 }, //30.7868*0.3425 },
    { "MC13TeV_WJets_ext2_2016", std::make_pair(86731806, 61526.7) }, //280929804 }, // 30.7868*0.6575 },
    /*
    ...
    */
    //DY
    { "MC13TeV_DYJetsToLL_10to50_2016"      , std::make_pair(51433009, 18610) }, //12.9777*0.434 },
    { "MC13TeV_DYJetsToLL_10to50_ext1_2016" , std::make_pair(51433009, 18610) }, //12.9777*0.566 },
