...
void TMVAReader::SetupMVAReader( std::string methodName, std::string modelPath )
{
  ...
  if ( methodName.find("SR2Class") != std::string::npos )
      ...
      if ( modelPath.find("2lepton") != std::string::npos)
	{
      ...
      myreader->AddVariable( "dmbbmin", &dmbbmin );
...
float TMVAReader::GenReMVAReader(  float thisdilep_pt, float thisdrll,float thisdhiHZ,float thisdphi_met_l,  float thisdphi_met_j,
                                 float thism4b,float thispt4b,float thismet,  float thisht,
                                 float thisn_ad_j,float thisptb1,float thisptb2,float thisbtag1,float thisbtag3,float thisdrbbav,float thisdmbbmin, std::string methodName)                           
{

  m4b=thism4b; pt4b=thispt4b;met=thismet; ht=thisht;
  ptb1=thisptb1;ptb2=thisptb2;  n_ad_j=thisn_ad_j;
  btag1=thisbtag1; btag3=thisbtag3;drbbav=thisdrbbav;dmbbmin=thisdmbbmin;
...
float TMVAReader::GenReMVAReader(float thism4b,float thispt4b,float thismet,  float thisht,float thisn_ad_j,float thisptb1,float thisptb2,float thisbtag1,float thisbtag3,float thisdrbbav,float thisdmbbmin, std::string methodName)                                
{
